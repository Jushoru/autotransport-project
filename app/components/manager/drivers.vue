...
import type {managerDriversTypes} from "~/types/demoTablesTypes";
import {managerDriversHeaders} from "~/config/demoTablesHeaders";
import {useDemoDbStore} from "~/stores/demoDbStore";
import {useDemoStore} from "~/stores/demoStore";
import DriverApplications from "~/components/driver/applications.vue";
